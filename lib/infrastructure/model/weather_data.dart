...
WeatherData universityDataFromJson(String str) => WeatherData.fromJson(json.decode(str));

String universityDataToJson(WeatherData data) => json.encode(data.toJson());
