...
abstract class $HomeStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({bool isLoading, WeatherData? weather, int selectIndex});
}
...
class _$HomeStateImpl extends _HomeState {
  const _$HomeStateImpl(
      {this.isLoading = false, this.weather = null, this.selectIndex = -1})
      : super._();
  ...
  @override
  String toString() {
    return 'HomeState(isLoading: $isLoading, weather: $weather, selectIndex: $selectIndex)';
  }
  ...
  @override
  int get hashCode => Object.hash(runtimeType, isLoading, weather, selectIndex);
...
abstract class _HomeState extends HomeState {
  const factory _HomeState(
      {final bool isLoading,
      final WeatherData? weather,
      final int selectIndex}) = _$HomeStateImpl;
